...
export async function deleteRecords  (context: any, entity: string, where: any, multiple:boolean=false, returnedFields: string[]) : Promise<any> {
...
export async function deleteRecord (context: any, entity: string, where: any, returnedFields: string[]) : Promise<any> {
