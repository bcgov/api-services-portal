...
export async function lookupProductEnvironmentServices (context: any, id: string) : Promise<Environment> {
...
export async function lookupProductEnvironmentServicesBySlug (context: any, appId: string) : Promise<Environment> {
    const result = await context.executeGraphQL({
