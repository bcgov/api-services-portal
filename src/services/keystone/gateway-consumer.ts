...
export async function lookupConsumerPlugins (context: any, id: string) : Promise<GatewayConsumer> {
...
export async function lookupKongConsumerId (context: any, id: string) : Promise<string> {
    const result = await context.executeGraphQL({
...
export async function lookupKongConsumerIdByName (context: any, name: string) : Promise<string> {
...
export async function lookupKongConsumerByCustomId (context: any, name: string) : Promise<GatewayConsumer> {
...
export async function addKongConsumer (context: any, username: string, customId: string, extForeignKey: string) : Promise<string> {
    logger.debug("Mutation [addKongConsumer] username=%s kongid=%s", username, extForeignKey)
