...
export const isUpdatingToIssued = (existingItem: any, updatedItem: any) => existingItem && (existingItem.isIssued == null || existingItem.isIssued == false) && updatedItem.isIssued
