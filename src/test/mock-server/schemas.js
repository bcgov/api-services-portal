...
input CredentialIssuerWhereInput {
  ...
  clientMappers: String
  clientMappers_not: String
  clientMappers_contains: String
  clientMappers_not_contains: String
  clientMappers_starts_with: String
  clientMappers_not_starts_with: String
  clientMappers_ends_with: String
  clientMappers_not_ends_with: String
  clientMappers_i: String
  clientMappers_not_i: String
  clientMappers_contains_i: String
  clientMappers_not_contains_i: String
  clientMappers_starts_with_i: String
  clientMappers_not_starts_with_i: String
  clientMappers_ends_with_i: String
  clientMappers_not_ends_with_i: String
  clientMappers_in: [String]
  clientMappers_not_in: [String]
  authPlugin: String
