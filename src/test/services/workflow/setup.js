...
const setup = () => {
    ...
    const server = setupServer(
      ...
      rest.post(
          ...
          (req, res, ctx) => {
              context.OUTPUTS.push({source: 'kong', type: 'POST consumer/key-auth', content: req.body})
              return res(
              ctx.json({
                id: '001',
                tags: [],
        ...
        rest.get(
          'http://kong-admin.local/consumers',
          (req, res, ctx) => {
            return res(
              ctx.json([{
        ...
        rest.get(
          'http://kong-admin.local/consumers/:consumer',
          (req, res, ctx) => {
        ...
        rest.post(
          'http://kong-admin.local/consumers',
          (req, res, ctx) => {
            context.OUTPUTS.push({source: 'kong', type: 'POST consumer', content: req.body})
            return res(
              ctx.json({
      ...
      rest.post(
          ...
          (req, res, ctx) => {
              context.OUTPUTS.push({source: 'kong', type: 'POST consumer/acls', content: req.body})
              return res(
              ctx.json({
                id: '002',
                tags: [],
      ...
      rest.delete(
          ...
          (req, res, ctx) => {
              context.OUTPUTS.push({source: 'kong', path: req.params, type: 'DELETE consumer/acls'})
              return res(
              ctx.json({})
            );
          }
      ...
      rest.post(
          ...
          (req, res, ctx) => {
              context.OUTPUTS.push({source: 'kong', type: 'POST consumer/plugins', content: req.body})
              return res(
              ctx.json(Object.assign({}, req.body, {id: 'plugin-1'}))
            );
          }
      ),
      rest.get(
