...
<Canvas>
  <Story 
    ...
    args={{
      ...
      data: [],
      emptyView: (
        <div style={{ paddingTop: 74, paddingBottom: 74 }}>
          <h2 style={{ fontWeight: '600', marginBottom: 14 }}>Empty Table Content</h2>
          <p style={{ fontSize: '0.85rem' }}>You can customize the view with any composition you'd like.<br/>It will be spaced inside these margins.</p>
        </div>
      ),
      sortable: true
    }}
