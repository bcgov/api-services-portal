...
const CreateIssuer = () => {
  ...
  const [issuer, setIssuer] = React.useState({
    ...
    owner: user == null ? { name: '', username: '', email: '' } : user,
  });
  ...
  const addNewIssuerEnvironment = (object) => {
    ...
    setIssuer({
      ...issuer,
      ...{ environmentDetails: issuer.environmentDetails },
    });
  };
      ...
      <Container maxW="6xl">
                ...
                <Box p={4}>
                  ...
                  >
                    <FormControl as="fieldset" isRequired>
                      ...
                      <RadioGroup
                        defaultValue={issuer.flow}
                        onChange={(e: string) =>
                          setIssuer({ ...issuer, ...{ flow: e } })
                        }
                      >
                        <Stack>
                    ...
                    <Alert status="info">
                      ...
                      <Box>
                        ...
                        Authorization Code Flow
                        <br />
                        <b>kong-api-key-acl</b> implements Kong's API Key and
                        ACL flow
                      </Box>
                    </Alert>
                    ...
                    {issuer.flow == 'client-credentials' && (
                      <>
                        <FormControl as="fieldset" isRequired>
                          ...
                          <RadioGroup
                            defaultValue={issuer.clientAuthenticator}
                            onChange={(e: string) =>
                              setIssuer({
                                ...issuer,
                                ...{ clientAuthenticator: e },
                              })
                            }
                          >
                            <Stack>
                  ...
                  <Box p={4}>
                    ...
                    >
                      <FormControl as="fieldset" isRequired>
                        ...
                        <RadioGroup
                          defaultValue={issuer.mode}
                          onChange={(e: string) =>
                            setIssuer({ ...issuer, ...{ mode: e } })
                          }
                        >
                          <Stack>
                      ...
                      <Alert status="info">
                        <AlertIcon />
                        <Box>
                          <b>Manual</b> issuing of the credential means that
                          this owner ({issuer.owner.name}) will complete setup
                          of the new credential with the particular OIDC
                          Provider, and communicate that to the requestor via
                          email or other means.
                          <br />
                          <b>Automatic</b> issuing of the credential means that
                          this owner ({issuer.owner.name}) has configured
                          appropriate credentials here to allow the API Manager
                          to manage Clients on the particular OIDC Provider.
                        </Box>
                      </Alert>

                      <FormControl mb={4} isDisabled={false}>
                        <FormLabel>Scopes</FormLabel>
                        <Textarea
                          name="availableScopes"
                          defaultValue={issuer.availableScopes.join('\n')}
                          onChange={(e: any) =>
                            setIssuer({
                              ...issuer,
                              ...{
                                availableScopes: e.target.value.split('\n'),
                              },
                            })
                          }
                        />
                      ...
                      <Alert status="info">
                        <AlertIcon />
                        <Box>
                          If your APIs are protected by Scope, then provide the
                          full list of Scopes setup in the idP.
                        </Box>
                      </Alert>
                      <FormControl mb={4} isDisabled={false}>
                        ...
                        <ListArray
                          ...
                          onChange={(value: string[]) =>
                            setIssuer({ ...issuer, ...{ clientRoles: value } })
                          }
                        />
                      </FormControl>
                      <Alert status="info">
                        <AlertIcon />
                        <Box>
                          If your APIs are protected by Roles, provide the full
                          list of Client Roles that will be used to manage
                          access to the APIs that are protected with this
                      ...
                      <FormControl mb={4} isDisabled={false}>
                        ...
                        <Textarea
                          ...
                          onChange={(e: any) =>
                            setIssuer({
                              ...issuer,
                              ...{ resourceScopes: e.target.value.split('\n') },
                            })
                          }
                        />
                      </FormControl>
                      <Alert status="info">
                        <AlertIcon />
                        <Box>
                          If your APIs are using UMA2 Resource Scopes, then
                          provide the full list of Scopes setup in the idP.
                        </Box>
                      </Alert>
                      ...
                      <FormControl mb={4} isDisabled={false}>
                        ...
                        <Input
                          ...
                          onChange={(e: any) =>
                            setIssuer({
                              ...issuer,
                              ...{ resourceAccessScope: e.target.value },
                            })
                          }
                        />
                      </FormControl>
                      <Alert status="info">
                        <AlertIcon />
                        <Box>
                          The Resource Access Scope identifies a Resource Scope
                          that, when granted to a user, allows them to
                          administer permissions for the particular resource.
                          This can be used when the Resource Server is the owner
                          of the resource.
                        </Box>
                      </Alert>
                    </Box>
              ...
              {flow == 'client-credentials' && (
                <Box bgColor="white" mb={4}>
                  ...
                  >
                    ...
                    <NewIssuerEnvironment
                      mode={issuer.mode}
                      onCreate={(d) => addNewIssuerEnvironment(d)}
                    />
                  </Box>
                  <Divider />
                  <Box bgColor="white" mb={4}>
                    ...
                    <Divider />
                    <IssuerEnvironmentList
                      data={issuer.environmentDetails}
                      state={'loaded'}
                      doDelete={deleteIssuerEnvironment}
                    />
                  </Box>
                </Box>
              )}
        ...
        <Box mt={5}>
          <ButtonGroup variant="outline" spacing="6" className="m-5">
            <Button colorScheme="blue" onClick={createProfile}>
              Create
            </Button>
