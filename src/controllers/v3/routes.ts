...
const models: TsoaRoute.Models = {
    ...
    "ValidateErrorJSON": {
        ...
        "properties": {
            ...
            "message": {"dataType":"enum","enums":["Invalid input"],"required":true},
            "fields": {"dataType":"nestedObjectLiteral","nestedProperties":{},"additionalProperties":{"dataType":"nestedObjectLiteral","nestedProperties":{"message":{"dataType":"string","required":true}}},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/ds/api/v3/gateways/:gatewayId/pattern',
            authenticateMiddleware([{"jwt":["GatewayConfig.Publish"]}]),

            async function GatewayConfigController_generateConfigFromPattern(request: any, response: any, next: any) {
            const args = {
                    gatewayId: {"in":"path","name":"gatewayId","required":true,"dataType":"string"},
                    body: {"in":"body","name":"body","required":true,"ref":"GatewayPatternConfigRequest"},
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
            ...
            try {
                ...
                const controller: any = await container.get<GatewayConfigController>(GatewayConfigController);
                if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
                }
