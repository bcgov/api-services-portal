...
const models: TsoaRoute.Models = {
    ...
    "CredentialIssuer": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"createdAt":{"ref":"Maybe_Scalars-at-DateTime_"},"updatedAt":{"ref":"Maybe_Scalars-at-DateTime_"},"createdBy":{"ref":"Maybe_User_"},"updatedBy":{"ref":"Maybe_User_"},"_environmentsMeta":{"ref":"Maybe__QueryMeta_"},"environments":{"dataType":"array","array":{"dataType":"refAlias","ref":"Environment"},"required":true},"owner":{"ref":"Maybe_User_"},"apiKeyName":{"ref":"Maybe_Scalars-at-String_"},"resourceType":{"ref":"Maybe_Scalars-at-String_"},"availableScopes":{"ref":"Maybe_Scalars-at-String_"},"clientAuthenticator":{"ref":"Maybe_Scalars-at-String_"},"clientRoles":{"ref":"Maybe_Scalars-at-String_"},"clientSecret":{"ref":"Maybe_Scalars-at-String_"},"clientId":{"ref":"Maybe_Scalars-at-String_"},"initialAccessToken":{"ref":"Maybe_Scalars-at-String_"},"oidcDiscoveryUrl":{"ref":"Maybe_Scalars-at-String_"},"instruction":{"ref":"Maybe_Scalars-at-String_"},"authPlugin":{"ref":"Maybe_Scalars-at-String_"},"mode":{"ref":"Maybe_Scalars-at-String_"},"clientRegistration":{"ref":"Maybe_Scalars-at-String_"},"flow":{"ref":"Maybe_Scalars-at-String_"},"description":{"ref":"Maybe_Scalars-at-String_"},"namespace":{"ref":"Maybe_Scalars-at-String_"},"name":{"ref":"Maybe_Scalars-at-String_"},"id":{"dataType":"string","required":true},"_label_":{"ref":"Maybe_Scalars-at-String_"},"__typename":{"dataType":"enum","enums":["CredentialIssuer"]}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
